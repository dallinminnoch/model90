  ...
  const LENS_NORMALIZATION_PLAN = {
    ...
    bucketMappings: {
      ...
      ongoingSupport: [
        ...
        { rawField: "propertyTax", canonicalField: "ongoingSupport.monthlyPropertyTax", availability: "activeLinkedPmi-derived", note: "Annual property-tax input normalized into a monthly housing-support cost." },
        ...
        { rawField: "associatedMonthlyCosts", canonicalField: "ongoingSupport.monthlyAssociatedHousingCosts", availability: "activeLinkedPmiCardOutput", note: "Current grouped associated monthly housing costs from the Housing Costs card." },
