  ...
  const LENS_NORMALIZATION_PLAN = {
    ...
    bucketMappings: {
      incomeBasis: [
        ...
        { rawField: "bonusVariableIncome", canonicalField: "incomeBasis.insuredVariableAnnualIncome", availability: "activeLinkedPmi", note: "Variable annual income kept separate from base insured income." },
        ...
        { rawField: "employerBenefitsValue", canonicalField: "incomeBasis.employerBenefitsAnnualValue", availability: "activeLinkedPmi", note: "Current HLV-support input." },
      ...
      ongoingSupport: [
        ...
        { rawField: "monthlyHousingCost", canonicalField: "ongoingSupport.monthlyHousingCost", availability: "activeLinkedPmi", note: "Current housing-cost field." },
        { rawField: "utilitiesCost", canonicalField: "ongoingSupport.monthlyUtilitiesCost", availability: "activeLinkedPmi", note: "Current monthly utilities field." },
        { rawField: "housingInsuranceCost", canonicalField: "ongoingSupport.monthlyHousingInsuranceCost", availability: "activeLinkedPmi", note: "Current monthly housing-insurance field." },
        { rawField: "propertyTax", canonicalField: "ongoingSupport.monthlyPropertyTax", availability: "activeLinkedPmi", note: "Current monthly property-tax field." },
        { rawField: "monthlyHoaCost", canonicalField: "ongoingSupport.monthlyHoaFees", availability: "activeLinkedPmi", note: "Current monthly HOA field." },
        { rawField: "monthlyMaintenanceRecommendation", canonicalField: "ongoingSupport.monthlyHomeMaintenanceCost", availability: "activeLinkedPmi-derived", note: "Derived readonly today; only saved when manually overridden." },
        ...
        { rawField: "subscriptionsCost", canonicalField: "ongoingSupport.monthlySubscriptionsCost", availability: "activeLinkedPmi", note: "Current monthly subscriptions field." },
        { rawField: "travelDiscretionaryCost", canonicalField: "ongoingSupport.monthlyTravelAndDiscretionaryCost", availability: "activeLinkedPmi", note: "Current monthly travel and discretionary field." },
    ...
    nonCanonicalOrUiOnlyRawFields: [
      ...
      { rawField: "calculatedMonthlyMortgagePayment", reason: "Useful derived helper, but not part of the first canonical bucket design." },
